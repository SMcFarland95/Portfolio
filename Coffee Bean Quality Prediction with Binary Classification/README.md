...
## Project Description:
According the National Coffee Association, 63% of Americans drink more coffee than any other type of beverage, including water, each day. (National Coffee Association, 2023) To meet this caffeine
demand for both the United States and worldwide, roughly 172 million bags of coffee are produced annually. Major coffee producers include Brazil, Columbia, Vietnam, and Indonesia. (USDA, 2023) Unfortunately, the quality of coffee beans produced is not always consistent. Factors that have been reported to affect coffee quality include coffee bean species (Arabica vs. Robusta), climatic growing conditions, soil quality, growing altitude, harvesting method (hand-picked vs. strip method), processing method (wet vs. dry), and storage conditions. (Deribe, 2019) This led to the Specialty Coffee Association to develop a standardized methology known as cupping to rate batches of coffee beans. 

Overall, coffee beans are given a score between 0 and 100. Any coffee graded below 80 is considered lowerquality and is typically used in commercial ground coffee. Coffee rated between 80 and 84.99 is
